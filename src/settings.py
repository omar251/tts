...
class AppSettings:
    ...
    def _load_config_file(self, config_path='tts/config.yaml'):
        """Loads settings from the config.yaml file."""
        # Ensure the config file path is relative to the project root if needed,
        # or handle absolute paths. Assuming config.yaml is in the tts directory.
