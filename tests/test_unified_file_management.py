...
async def main():
    """Run all tests."""
    print("🗂️  Unified File Management Test Suite")
    print("Testing centralized file management for all TTS artifacts")
    print("=" * 70)
    
    # Test unified file manager
    file_manager_success = await test_unified_file_manager()
    
    # Test integration with TTS
    integration_success = await test_integration_with_tts()
    
    # Summary
    print("\n" + "=" * 70)
    print("📊 Test Summary")
    print("=" * 70)
    print(f"File Manager Tests: {'✅ PASS' if file_manager_success else '❌ FAIL'}")
    print(f"TTS Integration Tests: {'✅ PASS' if integration_success else '❌ FAIL'}")
    
    if file_manager_success and integration_success:
        print("\n🎉 All tests passed! Unified file management is working correctly.")
        print("\n📁 File Organization Structure:")
        print("   temp/")
        print("   ├── session_YYYYMMDD_HHMMSS_uuid/")
        print("   │   ├── audio/          # All audio files (.wav)")
        print("   │   ├── text/           # All text files (.txt)")
        print("   │   ├── translation/    # Translation files")
        print("   │   └── cache/          # Cache files (voices, etc.)")
        print("   └── session_*/          # Other sessions...")
        print("\n✨ Benefits:")
        print("   • All artifacts organized in session-based directories")
        print("   • Automatic cleanup of session files")
        print("   • Consistent file naming and paths")
        print("   • Better disk space management")
        print("   • Easy to track and debug file operations")
        return 0
    else:
